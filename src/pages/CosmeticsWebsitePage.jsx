...
function CosmeticsWebsite() {
    return (
        <>
            <BannerPages title="Website for client"/>
            <ProjectDescription
            ...
            <Box className="box-button mt" textAlign='center'>
                <Button className="portfolio-button-1 center" href="https://dorinkozmetika.hu/" variant="contained">Click here to view the website</Button>
            </Box>
        </>
    );
}
